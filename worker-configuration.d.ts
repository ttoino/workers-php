/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=examples/demo/wrangler.jsonc` (hash: fa0352382aa52fddef6b221762878ce7)
// Runtime types generated with workerd@1.20260911.1 2026-05-26 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./examples/demo/worker");
	}
